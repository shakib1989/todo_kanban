...
TaskEditModel _$TaskEditModelFromJson(Map<String, dynamic> json) =>
    TaskEditModel(
      content: json['content'] as String?,
      description: json['description'] as String?,
      labels:
      ...
      dueText: json['due_string'] as String?,
      dueDate: DateTimeHelper.toDateTime(json['due_date'] as String?),
      dueDateTime: DateTimeHelper.toDateTime(json['due_datetime'] as String?),
...
Map<String, dynamic> _$TaskEditModelToJson(TaskEditModel instance) {
  ...
  writeNotNull('due_string', instance.dueText);
  val['due_date'] = DateTimeHelper.fromDateTime(instance.dueDate);
  val['due_datetime'] = DateTimeHelper.fromDateTime(instance.dueDateTime);
  writeNotNull('due_lang', instance.dueLang);
